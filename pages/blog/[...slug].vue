        ...
        <div class="text-muted mx-auto py-12 px-8 lg:px-16 w-full lg:max-w-[40rem] bg-gray-500/10 dark:bg-gray-900/40">
          ...
          <div class="flex justify-evenly items-center flex-wrap lg:block mt-6 lg:mt-12 my-4 lg:my-0 lg:space-x-4 text-center lg:text-left">
            <span
              ...
              class="text-[10px] lg:text-xs w-[45%] lg:max-w-full font-semibold mt-4 lg:mt-0 py-2 px-2 lg:px-4 rounded-lg text-gray-100 bg-blue-500 uppercase"
            >
              <Icon name="pajamas:label" size="0.8rem" class="text-gray-100 mr-2" />{{
                tag
              }}
            </span>
          </div>
...
#blog p {
  @apply text-xs lg:text-sm !leading-loose py-2;
}
#blog a,
#blog strong {
