...
<template>
  <div>
    <div class="bg-neutral-300/30 first-letter:dark:bg-neutral-800 rounded-lg p-6 mb-8">
      <form class="space-y-6" @submit.prevent="submitPost">
        <textarea
          ...
          rows="4"
          required
          class="text-sm md:text-base bg-neutral-50 dark:bg-neutral-900/50 w-full p-3 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-neutral-500 focus:border-transparent"
        />
        ...
        <div class="space-y-6">
          ...
          >
            ...
            <div class="flex justify-between items-center text-sm">
              <span class="flex items-center text-neutral-400 dark:text-neutral-600">
