...
export function useWorks(): Works[] {
  const works: Works[] = [
    ...
    { icon: 'line-md:external-link', title: 'Velocity Docs', tech: 'Vue', ui: 'TailwindCSS', url: 'velocity.ose.web.id' },
    { icon: 'line-md:github-loop', title: 'Velocity', tech: 'Electron', ui: 'TailwindCSS', url: 'github.com/ose-id/velocity' },
    ...
    { icon: 'line-md:external-link', title: 'Pong Game', tech: 'React', ui: 'CSS', url: 'pong-game-dewa.vercel.app' },
    ...
    { icon: 'line-md:external-link', title: 'GLB GLTF Viewer', tech: 'React', ui: 'CSS', url: 'glb-gltf-viewer-adydetra.vercel.app' },
    { icon: 'line-md:external-link', title: 'Fingertune', tech: 'React', ui: 'CSS', url: 'fingertune.vercel.app' },
    { icon: 'line-md:external-link', title: 'Black Hole ASCII', tech: 'Svelte', ui: 'CSS', url: 'black-hole-ascii.vercel.app' },
    { icon: 'line-md:github-loop', title: 'Video Music Converter', tech: 'Python', ui: 'Tkinter', url: 'github.com/adydetra/video-music-converter' },
  ];
  return works;
}
