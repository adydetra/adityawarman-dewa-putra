<template>
    <div class="mx-auto h-screen relative w-screen px-12 2xl:px-24 py-8 2xl:py-16 bg-[url('/assets/img/pattern-hero-left.png')] bg-contain bg-center">
            ...
            <div class="grid grid-cols-9 gap-8 xl:gap-16 2xl:gap-20">
                <!-- Project -->
                <NuxtLink data-aos="zoom-in" data-aos-duration="1000" :to="project.to" target="_blank" :title="project.title" class="col-span-3 cursor-pointer ease-in-out duration-300 hover:scale-105 hover:backdrop-saturate-200 flex justify-center border-dashed border-2 border-gray-800 pt-4 pb-6 hover:border-gray-100" v-for="project in projects" :key="project.id">
