<template>
  <NuxtLink
    ...
    class="bg-gray-100/30 dark:bg-transparent shadow-xl shadow-blue-500/5 dark:shadow-blue-800/5 dark:backdrop-saturate-200 hover:bg-yellow-200/20 col-span-4 cursor-pointer ease-in-out duration-300 hover:scale-105 rounded-2xl flex justify-center pt-4 pb-6"
  ...
  >
    ...
    <div class="flex justify-center items-center absolute bg-gray-300 text-black -top-4 -left-4 w-12 inset-0 h-12 rounded-full">
      <Icon :name="achievement.icon" class="w-3 h-3 lg:w-4 2xl:w-5 lg:h-4 2xl:h-5" />
    </div>
  </NuxtLink>
</template>
