<template>
  <div
    class="mx-auto min-h-screen w-screen px-40 2xl:px-24 py-8 2xl:py-16 container bg-[url('/assets/pattern-hero-left.png')] dark:bg-[url('/assets/pattern-hero-left-dark.png')] bg-contain bg-center"
  >
    <h1
      data-aos="fade-down"
