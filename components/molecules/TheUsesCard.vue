...
const link = "cursor-pointer ease-in-out duration-300 dark:text-gray-600 hover:text-yellow-400 dark:hover:text-yellow-200";
const icon = "w-3.5 h-3.5 md:w-4 md:h-4 2xl:w-5 2xl:h-5";
</script>
