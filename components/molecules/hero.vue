  ...
  <section class="grid grid-cols-8 h-screen lg:px-36 2xl:px-52">
    ...
    >
      <div class="xl:space-y-6 2xl:space-y-8">
        ...
        <p class="text-gray-400 xl:text-md 2xl:text-lg">~ I’m Adityawarman <span class="px-1 rounded-md bg-gray-200/50 dark:bg-gray-900">Dewa</span> Putra. Live in Jakarta, Indonesia. 🇮🇩</p>
        <AtomsSocialMedia />
      </div>
    </div>
    <div class="col-span-3 flex justify-center items-center bg-white dark:bg-yellow-200 bg-[url('/images/pattern-hero-right.png')] bg-contain bg-center">
      <div class="relative py-4 xl:w-[280px] 2xl:w-[360px] xl:h-[420px] 2xl:h-[540px]">
        ...
        <div class="flex justify-center items-center absolute bg-gray-100 border border-gray-300 text-black -top-4 -left-4 w-12 inset-0 h-12 rounded-full"><Icon size="30" name="meteocons:star-fill" /></div>
      </div>
    </div>
  </section>
</template>
