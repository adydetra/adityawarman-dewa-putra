                    ...
                    >
                        <SwiperSlide class="py-4">
                            <div class="relative py-4 xl:w-[280px] 2xl:w-[360px] xl:h-[420px] 2xl:h-[540px]">
                                <img src="~/assets/img/hero.webp" alt="" class="w-full h-full object-cover rotate-2 rounded-[2rem]" />
                        ...
                        <SwiperSlide class="py-4">
                            <div class="relative py-4 xl:w-[280px] 2xl:w-[360px] xl:h-[420px] 2xl:h-[540px]">
                                <img src="~/assets/img/mobile-2.webp" alt="" class="w-full h-full object-cover rotate-2 rounded-[2rem]" />
                                <div class="flex justify-center items-center absolute bg-gray-100 border border-gray-300 text-black -top-4 -left-4 w-12 inset-0 h-12 rounded-full">👋</div>
                            </div>
                        </SwiperSlide>
                        <SwiperSlide class="py-4">
                            <div class="relative py-4 xl:w-[280px] 2xl:w-[360px] xl:h-[420px] 2xl:h-[540px]">
                                <img src="~/assets/img/mobile-3.webp" alt="" class="w-full h-full object-cover object-left-bottom rotate-2 rounded-[2rem]" />
                                <div class="flex justify-center items-center absolute bg-gray-100 border border-gray-300 text-black -top-4 -left-4 w-12 inset-0 h-12 rounded-full">👋</div>
                            </div>
                        </SwiperSlide>
