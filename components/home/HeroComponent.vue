<template>
    <div class="bg-gradient-to-r from-gray-950 to-gray-900 mx-auto h-screen relative w-screen">
            <section class="grid grid-cols-8 h-screen">
                <div class="col-span-5 flex items-center py-40 px-24 bg-[url('/assets/pattern-hero-left.png')] bg-contain bg-center">
                    <div class="xl:space-y-6 2xl:space-y-8">
                        ...
                        <ul class="flex text-gray-400 xl:gap-7 2xl:gap-8">
                            <li>
                                <NuxtLink to="" class="cursor-pointer ease-in-out duration-300 hover:text-yellow-200">
                ...
                <div class="col-span-3 flex justify-center items-center bg-yellow-200 py-40 bg-[url('/assets/pattern-hero-right.png')] bg-contain bg-center">
                    <img src="~/assets/hero.png" alt="Photo" class="xl:w-64 2xl:w-96 rotate-3 rounded-[2rem] shadow-xl shadow-gray-500/40" />
                </div>
            </section>
        </div>
</template>