<template>
  ...
  <div
    class="mx-auto min-h-screen w-screen px-7 lg:px-40 2xl:px-24 py-14 2xl:py-16 container lg:bg-[url('/images/pattern-hero-left.png')] lg:dark:bg-[url('/images/pattern-hero-left-dark.png')] bg-contain bg-center"
  >
    ...
    <h1 class="text-gray-500 dark:text-gray-300 text-center text-4xl lg:text-3xl 2xl:text-4xl font-bold mb-12 md:mb-16">
      ...
      <div class="lg:hidden">Projects</div>
    </h1>

    <div class="grid grid-cols-8 lg:grid-cols-9 gap-8 xl:gap-16 2xl:gap-20">
      <AtomsCardProjects />
    </div>
