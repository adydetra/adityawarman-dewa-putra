<template>
  ...
  <div class="mt-6 text-gray-400 text-sm lg:text-base !leading-loose">
    ...
    <p class="mt-4">
      ...
      <NuxtLink to="https://pinterest.com/adydetra" title="Pinterest" aria-label="Pinterest" :class="link">Pinterest</NuxtLink>. If you happen to be in the same city as where
      I live (in Jakarta), maybe we could hang out and talk about tech or join
      <NuxtLink to="https://discord.gg/9z6APrYMAq" title="Discord" aria-label="Discord" :class="link">Discord</NuxtLink> to play games together.
    </p>
    <div class="mt-12">
      <p>Find Me On</p>
