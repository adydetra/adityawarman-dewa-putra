...
export function useWorks(): Works[] {
  const works: Works[] = [
    { icon: 'line-md:github-loop', title: 'Personal Site', tech: 'Nuxt', ui: 'UnoCSS', url: 'github.com/adydetra/adityawarman-dewa-putra' },
    ...
    { icon: 'line-md:github-loop', title: 'Bang CV', tech: 'Next', ui: 'TailwindCSS', url: 'github.com/adydetra/bangcv' },
    ...
    { icon: 'line-md:external-link', title: 'Averroes Unipessoal. Lda', tech: 'HTML', ui: 'Bootstrap', url: 'www.averroes.info' },
    ...
    { icon: 'line-md:github-loop', title: 'OSE', tech: 'Astro', ui: 'TailwindCSS', url: 'github.com/ose-id/ose' },
    ...
    { icon: 'line-md:external-link', title: 'Blog', tech: 'Nuxt', ui: 'TailwindCSS', url: 'blog.adydetra.my.id' },
  ];
  return works;
}
