...
export const projects = [
  ...
  data(5, "Learning Centre Indonesia", "Laravel Blade", "line-md:external-link", "https://learningcentreindonesia.com/web"),
  data(6, "Wangyland", "Nuxt", "line-md:external-link", "https://wangyland.vercel.app"),
  data(7, "Bang CV", "Next", "line-md:github-loop", "https://github.com/devdewa/bangcv"),
  data(8, "MP3 / MP4 Downloader", "Next", "line-md:external-link", "https://dewa-downloader.vercel.app"),
  ...
  data(12, "Protem", "Vue", "line-md:external-link", "https://pt-teknologi-pustaka-indonesia-buku.vercel.app/"),
